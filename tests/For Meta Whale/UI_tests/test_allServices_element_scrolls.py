...
scroll_button = driver.find_element(By.XPATH, "/html/body/div/div/div/header/ul/li[6]")
scroll_button.click()
time.sleep(10)

# h2
target_element = driver.find_element(By.XPATH, "/html/body/div/div/div/div[1]/section[7]/div[1]/picture/img")
