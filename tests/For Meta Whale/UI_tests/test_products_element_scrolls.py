...
scroll_button = driver.find_element(By.XPATH, "/html/body/div[1]/div/div/header/ul/li[4]/a")
scroll_button.click()
time.sleep(5)

# h2
target_element = driver.find_element(By.XPATH, "/html/body/div[1]/div/div/div[1]/section[4]/div[1]/div/h2")
...
time.sleep(2)  # Даем немного времени для завершения прокрутки
