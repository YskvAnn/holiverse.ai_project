...
try:
    ...
    driver.get("https://b.metaforce.app/news-portal")
    time.sleep(3)

    # нахожу и кликаю элемент
    product_item = driver.find_element(By.CSS_SELECTOR, "span.ico.ico--align.has-event")
    ...
    if current_url == "https://b.metaforce.app/":
