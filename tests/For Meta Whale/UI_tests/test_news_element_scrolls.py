...
scroll_button = driver.find_element(By.XPATH, "/html/body/div[1]/div/div/header/ul/li[2]/a")
scroll_button.click()
time.sleep(5)

# h2
target_element = driver.find_element(By.XPATH, "/html/body/div[1]/div/div/div[1]/section[2]/div/div[1]/div[1]/h2")
